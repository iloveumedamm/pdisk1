...
class Telegram:
    ...
    DB_NAME = str(env.get('SESSION_NAME', 'FileStream'))
    ...
    MULTI_CLIENT = False
    FLOG_CHANNEL = int(env.get("FLOG_CHANNEL", "-1002096211011"))   # Logs channel for file logs
    ULOG_CHANNEL = int(env.get("ULOG_CHANNEL", "-1002096211011"))   # Logs channel for user logs
